...
- [ ] 3.1 Run `cd packages/mimo-agent && bun test` — all tests pass
- [ ] 3.2 Run `cd packages/mimo-platform && bun test` — no regressions
- [ ] 3.3 Verify `packages/mimo-agent/src/index.ts` line count reduced by ~200 lines
