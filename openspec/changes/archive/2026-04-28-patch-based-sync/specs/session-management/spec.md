...
The system SHALL allow users to create sessions within a project. Each session creates repo.fossil but defers checkout creation to agent bootstrap. Each session SHALL include a `patches/` directory for storing historical patch files.
...
- **AND** system creates patches/ directory for historical patch storage
