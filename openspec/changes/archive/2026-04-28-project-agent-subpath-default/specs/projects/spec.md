...
- **MUST** include optional `agentSubpath` text input with placeholder "packages/backend"
- **MUST** display help text: "Relative path within the repository where agent sessions will start. Useful for monorepos."
