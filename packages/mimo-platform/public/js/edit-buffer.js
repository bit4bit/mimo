    ...
    async function sendExpertInstruction() {
      ...
      try {
        ...
        var fullPrompt =
          ...
          "* a user request\n\n" +
          "Your ONLY job is to analyze the request and return JSON instructions describing what changes should be made.\n" +
          "You do NOT execute any changes, edit any files, or make any tool calls.\n" +
          "You ONLY return JSON describing the replacements that should be applied.\n\n" +
          "Important behavior rules:\n\n" +
          "Scope rules:\n\n" +
          "* You ONLY analyze the active file shown in the editor (see Target file below).\n" +
          "* The file path in the output is INFORMATIONAL ONLY - it names the file being analyzed.\n" +
          ...
          "* You ONLY return JSON - you do NOT perform any actions.\n\n" +
          ...
          "  ]\n" +
          "}\n\n" +
          'IMPORTANT: The "file" field is INFORMATIONAL ONLY - it identifies which file the replacements apply to.\n' +
          "You do NOT edit this file. You ONLY return JSON describing what replacements should be made.\n\n" +
