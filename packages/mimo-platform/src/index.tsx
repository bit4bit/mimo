...
const internalVcsHost = process.env.MIMO_INTERNAL_VCS_HOST;
const publicVcsUrl = process.env.MIMO_PUBLIC_VCS_URL;
...
const env = {
  ...
  MIMO_HOME: mimoHome,
  MIMO_VCS_REPOS_DIR: vcsReposDir,
  MIMO_INTERNAL_VCS_PORT: process.env.MIMO_INTERNAL_VCS_PORT
    ? parseInt(process.env.MIMO_INTERNAL_VCS_PORT, 10)
    : 8000,
  MIMO_HOST: _host,
  MIMO_INTERNAL_VCS_HOST: internalVcsHost,
  MIMO_PUBLIC_VCS_URL: publicVcsUrl,
};
...
const sharedVcsServer = createGitHttpServer(
  env,
  os,
  async (sid, user, pass) => {
...
mimoContext.services.sharedVcs = sharedVcsServer;
