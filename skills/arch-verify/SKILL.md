...
| 3.2 | **Reveals intention**            | New function/class names describe _what_ from the caller's perspective, not _how_. No cryptic abbreviations or implementation-leaking names. |
...
| #   | Rule                                                | How to Verify                                                                                                                                     |
| --- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| 4.1 | **Tests written first (BDD)**                       | For every new behavior, is there a failing test _before_ implementation? Look for `test/` or `integration-test/` additions in the same commit/PR. |
